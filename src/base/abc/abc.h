...
extern ABC_DLL void               Abc_NtkRecStart3( Gia_Man_t * p, int nVars, int nCuts, int fFuncOnly, int fVerbose, int nAreaMargin );
...
extern ABC_DLL int                Abc_NtkRecFilter3(int nLimit);
